...
//     if (!tokenToUse) {
//         setError("CSRF token unavailable. Cannot perform this action.");
//         return;
//     }
// }
...
export default function AdminEmployeeProfilesPage() {
    ...
    // Helper to always get a valid CSRF token
    ...
    const fetchEmployeeProfiles = async () => {
        ...
        try {
            ...
            const response = await fetch('https://hr-backend-xs34.onrender.com/api/employee-profiles/', {
                method: 'GET',
                headers: { 'Content-Type': 'application/json', 'X-CSRFToken': tokenToUse },
                credentials: 'include',
            });
    ...
    const handleDeleteProfile = async (id) => {
        ...
        try {
            ...
            const response = await fetch(`https://hr-backend-xs34.onrender.com/api/employee-profiles/${id}/`, {
                method: 'DELETE',
                headers: { 'X-CSRFToken': tokenToUse },
                credentials: 'include',
            });
