...
export default function AdminDepartmentsPage() {
    ...
    const handleUpdateDepartment = async (e) => {
        ...
        try {
            const csrftoken = getCookie('csrftoken');
            const response = await fetch(`http://hr-backend-xs34.onrender.com/api/admin/departments/${editingDepartment.id}/`, {
                method: 'PUT', 
                headers: {
                    'Content-Type': 'application/json',
                    'X-CSRFToken': csrftoken,
    ...
    const handleDeleteDepartment = async (id) => {
        ...
        try {
            const csrftoken = getCookie('csrftoken');
            const response = await fetch(`http://hr-backend-xs34.onrender.com/api/admin/departments/${id}/`, {
                method: 'DELETE',
                headers: {
                    'X-CSRFToken': csrftoken,
                },
